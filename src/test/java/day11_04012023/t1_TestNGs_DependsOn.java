...
public class t1_TestNGs_DependsOn {
    WebDriver driver;
    ...
    //use depends for test case to run in order
    @Test (dependsOnMethods = {"searchKeyWord","clickOnFinance"})
    public void clickOnFinance() {
        ReuseableMethods.clickMethod(driver," //div[text()='Finance']","Finance");
    }//end of test 3
